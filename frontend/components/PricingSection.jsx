...
export default function PricingSection({ subscriptionTier = "free" }) {
  ...
  const canCheckout = Boolean(proPlanId);
        ...
        <Card className="relative border-2 border-orange-600 bg-orange-50">
          ...
          <CardHeader>
            ...
            {subscriptionTier === "pro" && (
              <Badge className="w-fit bg-green-600 text-white border-none">
                Active Plan
              </Badge>
            )}
          </CardHeader>
          ...
          <CardFooter>
            <SignedIn>
              {subscriptionTier === "pro" ? (
                <Button
                  disabled
                  className="w-full bg-orange-500 disabled:cursor-not-allowed text-white"
                >
                  Active Plan
                </Button>
              ) : canCheckout ? (
                ...
                <Button
                  disabled
                  className="w-full bg-orange-400 disabled:cursor-not-allowed text-white"
                  title="Set NEXT_PUBLIC_CLERK_PRO_PLAN_ID in frontend/.env"
                >
                  Plan Not Configured
                </Button>
              )}
